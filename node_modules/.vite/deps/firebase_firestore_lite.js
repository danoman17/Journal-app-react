...
function Ct(t) {
  return "nullValue" in t ? 0 : "booleanValue" in t ? 1 : "integerValue" in t || "doubleValue" in t ? 2 : "timestampValue" in t ? 3 : "stringValue" in t ? 5 : "bytesValue" in t ? 6 : "referenceValue" in t ? 7 : "geoPointValue" in t ? 8 : "arrayValue" in t ? 9 : "mapValue" in t ? St(t) ? 4 : (
...
function te(t, e) {
  ...
  }(t, e) : t instanceof Zt ? function(t2, e2) {
    if (e2 instanceof Zt && t2.op === e2.op && t2.filters.length === e2.filters.length) {
      return t2.filters.reduce((t3, n, r) => t3 && te(n, e2.filters[r]), true);
    }
    return false;
  }(t, e) : void b();
}
...
function Re(t) {
  ...
  if (null === e.q) {
    ...
    if (null !== t2 && null === n)
      t2.isKeyField() || e.q.push(new ae(t2)), e.q.push(new ae(
        nt.keyField(),
        "asc"
        /* Direction.ASCENDING */
      ));
...
function $e(t, e) {
  return function(t2, e2) {
    ...
    for (let n = 0; n < t2.orderBy.length; n++)
      if (!he(t2.orderBy[n], e2.orderBy[n]))
        return false;
    if (t2.filters.length !== e2.filters.length)
      return false;
    for (let n = 0; n < t2.filters.length; n++)
      if (!te(t2.filters[n], e2.filters[n]))
        return false;
    return t2.collectionGroup === e2.collectionGroup && !!t2.path.isEqual(e2.path) && !!Ht(t2.startAt, e2.startAt) && Ht(t2.endAt, e2.endAt);
...
function rn(t, e) {
  return "found" in e ? function(t2, e2) {
    ...
    const n = Ze(t2, e2.found.name), r = He(e2.found.updateTime), s = e2.found.createTime ? He(e2.found.createTime) : le.min(), i = new ge({
      mapValue: {
    ...
    const n = Ze(t2, e2.missing), r = He(e2.readTime);
...
async function gn(t, e) {
  const n = I(t), r = en(n.serializer) + "/documents", s = {
    documents: e.map((t2) => Xe(n.serializer, t2))
  }, i = await n.R("BatchGetDocuments", r, s, e.length), o = /* @__PURE__ */ new Map();
  i.forEach((t2) => {
    const e2 = rn(n.serializer, t2);
...
async function vn(t, e, n) {
  var r;
  const s = I(t), { request: i, Z: o } = function(t2, e2, n2) {
    const r2 = on(t2, e2), s2 = {}, i2 = [];
    let o2 = 0;
    return n2.forEach((t3) => {
      const e3 = "aggregate_" + o2++;
      s2[e3] = t3.alias, "count" === t3.$ ? i2.push({
        alias: e3,
        count: {}
      }) : "avg" === t3.$ ? i2.push({
        alias: e3,
        avg: {
          field: hn(t3.fieldPath)
        }
      }) : "sum" === t3.$ && i2.push({
        alias: e3,
        sum: {
...
var In = class {
  constructor(t) {
    ...
    ), this.experimentalLongPollingOptions = ht(null !== (n = t.experimentalLongPollingOptions) && void 0 !== n ? n : {}), function(t2) {
...
var er = class extends jn {
  ...
  _toFieldTransform(t) {
    const e = Zn(
      ...
      /*array=*/
      true
    ), n = this.dt.map((t2) => ur(t2, e)), r = new xe(n);
...
var nr = class extends jn {
  ...
  _toFieldTransform(t) {
    const e = Zn(
      ...
      /*array=*/
      true
    ), n = this.dt.map((t2) => ur(t2, e)), r = new Se(n);
    return new Oe(t.path, r);
  }
  isEqual(t) {
    return this === t;
...
function or(t, e, n, r = false) {
  return ur(n, t.ft(r ? 4 : 3, e));
}
function ur(t, e) {
  if (ar(
...
var Er = class extends br {
};
function Ir(t, e, ...n) {
  let r = [];
  e instanceof br && r.push(e), r = r.concat(n), function(t2) {
    const e2 = t2.filter((t3) => t3 instanceof Rr).length, n2 = t2.filter((t3) => t3 instanceof Tr).length;
    if (e2 > 1 || e2 > 0 && n2 > 0)
...
var Tr = class extends Er {
  ...
  _parse(t) {
    const e = Hn(t.firestore), n = function(t2, e2, n2, r, s, i, o) {
      let u;
      if (s.isKeyField()) {
        ...
        "in" !== i && "not-in" !== i && "array-contains-any" !== i || jr(o, i), u = or(
          n2,
          e2,
          o,
          /* allowArrays= */
...
function Pr(...t) {
  return t.forEach((t2) => zr("or", t2)), Rr._create("or", t);
}
function Vr(...t) {
  return t.forEach((t2) => zr("and", t2)), Rr._create("and", t);
}
var $r = class extends Er {
  /**
   * @internal
   */
  constructor(t, e) {
  ...
  _apply(t) {
    ...
    return new Fn(t.firestore, t.converter, function(t2, e2) {
      const n = t2.explicitOrderBy.concat([e2]);
      return new Ee(t2.path, t2.collectionGroup, n, t2.filters.slice(), t2.limit, t2.limitType, t2.startAt, t2.endAt);
    }(t._query, e));
  }
};
function Nr(t, e = "asc") {
...
var Dr = class extends Er {
  ...
  _apply(t) {
    return new Fn(t.firestore, t.converter, function(t2, e, n) {
...
var Sr = class extends Er {
  ...
  _apply(t) {
    ...
    return new Fn(t.firestore, t.converter, function(t2, e2) {
      return new Ee(t2.path, t2.collectionGroup, t2.explicitOrderBy.slice(), t2.filters.slice(), t2.limit, t2.limitType, e2, t2.endAt);
    }(t._query, e));
  }
};
function qr(...t) {
...
var kr = class extends Er {
  ...
  _apply(t) {
    const e = Lr(t, this.type, this._docOrFields, this._inclusive);
    return new Fn(t.firestore, t.converter, function(t2, e2) {
      return new Ee(t2.path, t2.collectionGroup, t2.explicitOrderBy.slice(), t2.filters.slice(), t2.limit, t2.limitType, t2.startAt, e2);
    }(t._query, e));
  }
};
function Cr(...t) {
...
function zr(t, e) {
  if (!(e instanceof Tr || e instanceof Rr))
...
function es(t, e) {
  const n = ct(t.firestore, Tn), r = En(n), s = function(t2, e2) {
    const n2 = [];
    for (const r2 in t2)
      Object.prototype.hasOwnProperty.call(t2, r2) && n2.push(e2(t2[r2], r2, t2));
    return n2;
  }(e, (t2, e2) => new vt(e2, t2._aggregateType, t2._internalFieldPath));
  return vn(r, t._query, s).then((e2) => function(t2, e3, n2) {
    const r2 = new Gr(t2);
...
var fs = class {
  /** @hideconstructor */
  constructor(t, e) {
    this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = false, this._dataReader = Hn(t);
  }
  set(t, e, n) {
  ...
  update(t, e, n, ...r) {
    ...
    let i;
    return i = "string" == typeof (e = getModularInstance(e)) || e instanceof Ln ? ir(this._dataReader, "WriteBatch.update", s._key, e, n, r) : sr(this._dataReader, "WriteBatch.update", s._key, e), this._mutations.push(i.toMutation(s._key, ke.exists(true))), this;
  }
  /**
...
var ms = class {
  ...
  async commit() {
    ...
    }), await yn(this.datastore, this.mutations), this.committed = true;
  }
  recordVersion(t) {
    let e;
  ...
  precondition(t) {
    ...
    return !this.writtenDocs.has(t.toString()) && e ? e.isEqual(le.min()) ? ke.exists(false) : ke.updateTime(e) : ke.none();
  }
  /**
...
var ys = class {
  constructor(t, e, n, r, s) {
    this.asyncQueue = t, this.datastore = e, this.options = n, this.updateFunction = r, this.deferred = s, this.yt = n.maxAttempts, this.gt = new mn(
      this.asyncQueue,
      "transaction_retry"
...
var vs = class {
  constructor() {
    ...
    this.Dt = () => {
      const t2 = gs();
      t2 && y("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.gt.H();
    };
    const t = gs();
  ...
  enqueueAfterDelay(t, e, n) {
    ...
    const r = _s.createAndSchedule(this, t, e, n, (t2) => this.qt(t2));
  ...
  get(t) {
    ...
    return this._transaction.lookup([e._key]).then((t2) => {
      ...
      if (r.isFoundDocument())
        return new pr(this._firestore, n, r.key, r, e.converter);
      if (r.isNoDocument())
        return new pr(this._firestore, n, e._key, null, e.converter);
      throw b();
    });
  }
  set(t, e, n) {
...
function Es(t, e, n) {
  ...
  const i = new j();
  return new ys(new vs(), r, s, (n2) => e(new bs(t, n2)), i).run(), i.promise;
}
!function(t) {
  w = t;
...
export {
  ...
  Mn as Bytes,
  xn as CollectionReference,
  Dn as DocumentReference,
  pr as DocumentSnapshot,
  Ln as FieldPath,
  jn as FieldValue,
  Tn as Firestore,
  U as FirestoreError,
  Bn as GeoPoint,
  Fn as Query,
  Rr as QueryCompositeFilterConstraint,
  Er as QueryConstraint,
  yr as QueryDocumentSnapshot,
  kr as QueryEndAtConstraint,
  Tr as QueryFieldFilterConstraint,
  Dr as QueryLimitConstraint,
  $r as QueryOrderByConstraint,
  gr as QuerySnapshot,
  Sr as QueryStartAtConstraint,
  xt as Timestamp,
  bs as Transaction,
  fs as WriteBatch,
  Zr as addDoc,
  is as aggregateFieldEqual,
  os as aggregateQuerySnapshotEqual,
  Vr as and,
  hs as arrayRemove,
  as as arrayUnion,
  rs as average,
  Sn as collection,
  qn as collectionGroup,
  Pn as connectFirestoreEmulator,
  ss as count,
  Xr as deleteDoc,
  us as deleteField,
  On as doc,
  ...
  Cn as queryEqual,
  kn as refEqual,
  Es as runTransaction,
  cs as serverTimestamp,
  Hr as setDoc,
  p as setLogLevel,
  _r as snapshotEqual,
  Or as startAfter,
